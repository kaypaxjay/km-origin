...
export default function Selection() {
    ...
    const handleShare = () => {
        const text =
            choice === "ello"
                ? "I’m Kekius Maximus, Champion of the People! Play Kekius Maximus: The Origins: [your-url] #KekiusMaximus"
                : "I’m Kekius Maximus, Lord of the Bold! Play Kekius Maximus: The Origins: [your-url] #KekiusMaximus";
